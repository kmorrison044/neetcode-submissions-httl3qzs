...
class Twitter {
    ...
    public List<Integer> getNewsFeed(int userId) {
        ...
        // Make a Priority Queue of a list of "Objects" since the queue will
        // be handling multiple data types. We will convert back to specific 
        // data types when we pop  out of the Queue
        ...
        {
            // Unpack "Object" list to specific variables and types
            Object[] top = q.poll();
            int time = (int) top[0];
            int tid = (int) top[1];
            User u = (User) top[2];
            ...
            if (index >= 0)
            {
                // Unfortunately we have to convert the posts deque to an array, since
                // there is no way to access all elements without it being converted to an array
